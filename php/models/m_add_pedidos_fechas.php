...
$sql = "SELECT num_pedido, email, metodo_pago, tarjeta, fecha_registro FROM pedido where DATE_FORMAT(fecha_registro,'%Y-%m-%d')>='$fechaDesde' AND DATE_FORMAT(fecha_registro,'%Y-%m-%d')<='$fechaHasta' order by num_pedido";
