...
<head>
    ...
    <title>admin-reservas-fechas</title>
...
<body>
    ...
    <h1 class="text-center">Reservas entre fechas</h1><BR>
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){//despues de submit
        ...
        require_once(".././models/m_add_reservas_fechas.php");

        require_once(".././views/v_add_reservas_fechas.php");
    }
