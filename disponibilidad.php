...
<form method="POST" action="" target="reservas">
    ...
    <input id="disp" type="submit" name="form" value="Disponibilidad"> 
</form>
<?php
}
if ($_SERVER["REQUEST_METHOD"]=="POST" && $_POST['form']=='Disponibilidad') { //comprobacion de boton de submit correcto
    ...
    if($fecha>=$fecha_actual && $fecha!="1970-01-01" && disponibilidad($comensales, $fecha, $hora)){ //si se puede hacer la reserva
        $disponibilidad=true;
    }
    else{
        ?>
